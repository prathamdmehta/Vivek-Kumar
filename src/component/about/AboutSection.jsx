          ...
          >
            ...
            <div className="relative mb-5">
              ...
              <img
                src={profileImageUrl}
                alt="Vivek Kumar"
                className="relative w-28 h-28 rounded-full border-4 border-slate-800 object-cover"
              />
              {/* Online dot */}
          ...
          >
            ...
            <div className="flex flex-wrap gap-2 mt-6">
              {['React', 'Next.js', 'Node.js', 'MongoDB', 'Tailwind CSS', 'Framer Motion', 'TypeScript'].map(tech => (
                <span key={tech} className="text-xs bg-slate-700/70 text-cyan-300 px-3 py-1 rounded-full border border-slate-600/50 font-medium">
                  {tech}
                </span>
              ))}
            </div>
          ...
          <div className="flex items-start gap-4 mb-6">
            ...
            <div>
              ...
              <p className="text-xl font-bold text-white leading-snug">
                A village soul with a high-speed city processor.
              </p>
            </div>
          </div>
