...
const ContactPage = ({ onNavigateHome }) => {
  ...
  const validate = () => {
    ...
    if (!formData.name.trim()) {
      ...
      newErrors.name = "Names cannot contain numbers or symbols"
    }
    ...
    if (wordCount < 1) {
      ...
      newErrors.message = "Message limit is 1000 words"
    }
  ...
  return (
    <section className="py-24 bg-slate-950 text-white min-h-screen flex items-center">
      <ThankYouModal
        ...
        message={successMessage || "Got it, Vivek! Your message is in my inbox. I'll get back to you faster than a Mumbai local reaches Dadar!"}
      />
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
              ...
              {socialLinks.map((item, i) => {
                ...
                return (
                  <motion.a
                    ...
                    className="p-3 bg-slate-900 rounded-full border border-slate-800 hover:border-blue-500 transition-colors"
                  >
                    <Icon size={20} />
                  </motion.a>
                )
          ...
          <motion.div
            ...
            className="bg-slate-900/50 p-8 rounded-3xl border border-slate-800 backdrop-blur-xl shadow-2xl"
          >
            <form className="space-y-6" onSubmit={handleSubmit}>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    className={`w-full bg-slate-800 border ${errors.name ? 'border-red-500' : 'border-slate-700'} rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all`}
                  />
                ...
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    className={`w-full bg-slate-800 border ${errors.email ? 'border-red-500' : 'border-slate-700'} rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all`}
                  />
                ...
                <div className="space-y-2 md:col-span-2">
                  ...
                  <input
                    ...
                    className={`w-full bg-slate-800 border ${errors.number ? 'border-red-500' : 'border-slate-700'} rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all`}
                  />
              ...
              <div className="space-y-2">
                ...
                <textarea
                  ...
                  className={`w-full bg-slate-800 border ${errors.message ? 'border-red-500' : 'border-slate-700'} rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all`}
                />
              ...
              <motion.button
                ...
                className="w-full bg-gradient-to-r from-blue-600 to-purple-600 text-white font-bold py-4 rounded-xl flex items-center justify-center gap-2 shadow-lg shadow-blue-500/20 disabled:cursor-not-allowed disabled:opacity-60"
              >
