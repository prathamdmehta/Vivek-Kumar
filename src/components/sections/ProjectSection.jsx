          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {loading
              ? skeletonCards.map((_, index) => (
                  <div key={index} className="animate-pulse rounded-xl bg-slate-900/80 p-6 shadow-lg border border-slate-700">
                  ...
                  >
                    ...
                    >
                      ...
                      <div className="flex gap-4 flex-wrap justify-center">
                        <motion.a whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.98 }} href={project.repoLink} target="_blank" rel="noreferrer" className="flex items-center gap-2 bg-white text-slate-900 px-5 py-2 rounded-full font-bold">
                          <Github size={18} /> Code
                        </motion.a>
                        <motion.a whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.98 }} href={project.liveLink} target="_blank" rel="noreferrer" className="flex items-center gap-2 bg-blue-600 text-white px-5 py-2 rounded-full font-bold">
