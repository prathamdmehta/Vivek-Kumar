      ...
      >
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <input type="text" defaultValue="Vivek Kumar" className="w-full bg-zinc-800 border border-zinc-700 rounded p-3 text-white focus:outline-none focus:border-accent" />
          </div>
