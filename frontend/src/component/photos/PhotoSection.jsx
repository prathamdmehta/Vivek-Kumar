        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {loading
            ? skeletonItems.map((_, i) => (
                <div
                  key={i}
                  className="aspect-square rounded-3xl bg-slate-900 border border-slate-800 animate-pulse"
                />
              ))
            : photos.length === 0
            ? (
          ...
          >
            ...
            >
              <img
                ...
                alt={photos[lightbox].caption || photos[lightbox].originalName}
              ...
              <button
                onClick={() => setLightbox(null)}
                className="absolute -top-4 -right-4 bg-slate-800 hover:bg-red-600 transition-colors rounded-full p-2"
              >
                <X size={20} />
              </button>
              ...
              <button
                ...
                className="absolute left-2 top-1/2 -translate-y-1/2 bg-black/60 hover:bg-black/80 rounded-full p-2 transition-colors"
              >
                <ChevronLeft size={24} />
              </button>
              ...
              <button
                ...
                className="absolute right-2 top-1/2 -translate-y-1/2 bg-black/60 hover:bg-black/80 rounded-full p-2 transition-colors"
              >
